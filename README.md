...
A MuJoCo-based simulation framework comparing different motor control strategies for quadruped locomotion with realistic muscle spindle feedback.
...
- **Rehabilitation**: Movement disorder analysis
